...
initialCache = ((0, 0), empty 1000 AddToCache :: Car)
...
removeFromT2 = [ (Read, "1", 1)   -- fail, to t1
               , (Read, "2", 999) -- fail, to t1
               , (Read, "3", 1) -- fail, to t1, 1 to b1
               , (Read, "1", 1) -- fail, 1 to t2, 2 to b1, targetSize = 10
               , (Read, "4", 1000) -- fail, 1 to b2
               , (Read, "1", 1) -- fail
               ]
